...
export function Upload() {
  ...
  const processExcelMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      if (data.processingStatus?.processing || data.filesCreated > 0) {
        ...
        const totalFiles =
          data.processingStatus?.total || data.filesCreated || 0;
  ...
  const processingFiles = Array.isArray(files)
    ? files.filter(
        (file: any) =>
    ...
    : [];
  const completedFiles = Array.isArray(files)
    ? files.filter((file: any) => file.processingStatus === "completed")
    : [];
  const errorFiles = Array.isArray(files)
    ? files.filter((file: any) => file.processingStatus === "error")
    : [];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Upload documents for AI-powered analysis and organization
          </p>
        </div>
          ...
          <div className="lg:col-span-3">
            ...
            <Card className="mb-8">
              <CardHeader>
                ...
                <CardDescription>
                  Upload an Excel file to automatically create folder structures
                  and import content
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  {processExcelMutation.isPending && (
                    <div className="bg-blue-50 p-4 rounded-lg space-y-3">
                      ...
                      <p className="text-xs text-blue-600">
                        Creating folder structure and importing files...
                      </p>
                    </div>
                  )}
                  ...
                  {isProcessingAI && (
                    <div className="bg-purple-50 p-4 rounded-lg space-y-3">
                      ...
                      <p className="text-xs text-purple-600">
                        Processing {Math.round(aiProcessingProgress)}% complete
                        - Transcribing videos and generating AI metadata...
                      </p>
                    </div>
                  )}
                      ...
                      <Alert className="border-green-200 bg-green-50">
                        ...
                        <AlertDescription className="text-green-800">
                          ...
                          <div className="space-y-1 text-sm">
                            <p>
                              ✓ Created {excelProcessingResult.foldersCreated}{" "}
                              folders
                            </p>
                            <p>
                              ✓ Imported {excelProcessingResult.filesCreated}{" "}
                              files
                            </p>
                            <p>
                              ✓ All files processed with AI transcription and
                              metadata
                            </p>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg text-sm text-gray-600">
                    ...
                    <ul className="space-y-1 list-disc list-inside">
                      <li>
                        Upload an Excel file with curriculum or content
                        structure
                      </li>
                      <li>
                        System automatically detects subject/folder columns
                      </li>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {files.slice(0, 8).map((file: any) => (
                      <div
                        key={file.id}
                        className="flex items-center space-x-3 p-3 border border-slate-200 rounded-lg hover:border-blue-300 transition-colors"
                      >
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-slate-600">
                      GPT extracts key information, themes, and categorizes
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Supports PDF, DOCX, and TXT files with text extraction up
                      to 100MB
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Automatically sorts into Personal/Life, Academic, or other
                      custom categories
                    </p>
                  </div>
                </div>
